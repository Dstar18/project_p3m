...
-- Started on 2021-12-08 15:21:51 WIB
...
COPY public.tb_artikelkategori (arkat_id, arkat_artikel_id, arkat_kategori_id) FROM stdin;
79	20	1
80	20	4
81	18	4
82	22	1
...
COPY public.tb_kategori (kategori_id, kategori_nama) FROM stdin;
...
COPY public.tb_pengaturan (pengaturan_id, pengaturan_nama, pengaturan_logo, pengaturan_telp, pengaturan_fb, pengaturan_ig, pengaturan_ytb) FROM stdin;
1	LPPMITDA	logo-211123-218ee10181.png	274451263	https://web.facebook.com/ITDA.YK	https://www.instagram.com/itda.yogyakarta/	https://www.youtube.com/channel/UCdKcJvmLjJWTsQ97cnG_YCQ
\.
...
COPY public.tb_pengumumankategori (pgmkat_id, pgmkat_pengumuman_id, pgmkat_kategori_id) FROM stdin;
2	2	4
3	2	5
10	1	5
11	4	5
...
COPY public.tb_petugas (petugas_id, "petugas_NIP", petugas_nama, petugas_email, petugas_nohp, petugas_password, petugas_img_profil, petugas_level) FROM stdin;
28	54321	Dedi Bintang	dedi@mail.com	884748	admin	imgprofil-211114-b766a782d0.jpg	1
29	54321	Satria Penulis	satria@mail.com	54353454	penulis	imgprofil-211116-91546d986a.jpg	2
26	12345	admin 1	admin@email.com	12345	admin	imgprofil-211105-86f2400d62.jpg	1
\.
...
-- Completed on 2021-12-08 15:21:53 WIB
